...
ResponseInfo=read.csv('NV.MMI.InputExtentTRIAL.2014_gfp.csv')
#FLAT
...
extentVAR=c('MMI','EvalStatus','VALXSITE')#Extent Estimate added here since weights the same (rather than running cat.analysis twice)
responseVAR=c('MMI')
