...
IndicatorCheckJoin=join_all(list(BnkCvr,BnkStb,PHfinal,fishpvt2,DensPvt,XCMGW_new1,XCMG_new1,XGB_new1,IncBnk,PCT_SAFN_ALL,XEMBED,BnkDensPvt,W1_HALL,QR1),by="UID")
